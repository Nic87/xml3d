		...
		createRoom : function(){
			...
			if( a < 1 || b < 1 || h < 1 || parseInt(a) - a != 0 || parseInt(b) - b != 0 || parseInt(h) - h != 0){
				...
				if(a <= b){
					...
					id_1 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", 0, h-0.5*a, -b);
					id_2 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", 0, -0.5*a, 0);
					id_3 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", 0, h-0.5*a, b);
					id_4 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", 1*a, h-0.5*a, 0);
					id_5 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", -1*a, h-0.5*a, 0);
				}
				else{

					id_1 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", 0, h-0.5*b, -b);
					id_2 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", 0, -0.5*b , 0);
					id_3 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", 0, h-0.5*b, b);
					id_4 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", 1*a, h-0.5*b, 0);
					id_5 = X3D.main.createElementFromGeneric(X3D.gen.getGUID(),"default","Wand", -1*a, h-0.5*b, 0);
				}
