...
X3D.tb = function() {
    ...
    return {
        ...
        addShadersToList: function(itemList){
            ...
            X3D.dom.deleteAllChilds(itemList);
        ...
        changeShaderDialog : function(){
            if(X3D.main.elementsAreSelected()){
                ...
                X3D.dom.deleteAllChilds(content);
                X3D.dom.deleteAllChilds(items);
        ...
        submitCreateBoxDialog : function(){
            ...
            if(this.isNumeric(x) && this.isNumeric(y) && this.isNumeric(z) && name.value.length >3 && selection != null){
                if(document.getElementById(name)){
					...
					X3D.main.createElementFromGeneric(texts[0],texts[1], x, y, z);
                }
            } else {
