    ...
    return {
		...
		*/
		...
		initializeViews : function (){
			...
			// camera 1	
			c[0][0] = 0; // x position
			c[0][1] = h + ((a+b)/2); // y position
			c[0][2] = 0; // z position
			c[0][3] = 1; // axis for rotation (x = 1)
			c[0][4] = 0; // direction for rotation 
			c[0][5] = 3.141592; // angle for rotation 
			
			// camera 2
			c[1][0] = 0; // x position
			c[1][1] = h; // y position
			c[1][2] = (b+a)/2; // z position
			
			// camera 3
			c[2][0] = -(b+a)/2; // x position
			c[2][1] = h; // y position
			c[2][2] = 0; // z position
			c[2][3] = 0; // axis for rotation (y = 0)
			c[2][4] = 1; // direction for rotation (right)
			c[2][5] = 1.570796; // angle for rotation 
			
			// camera 4
			c[3][0] = 0; // x position
			c[3][1] = h; // y position
			c[3][2] = -(b+a)/2; // z position
			c[3][3] = 0; // axis for rotation (y = 0)
			c[3][4] = 0; // direction for rotation (left)
			c[3][5] = 3.141592; // angle for rotation 

			// camera 5
			c[4][0] = (b+a)/2;; // x position
			c[4][1] = h; // y position
			c[4][2] = 0;
			c[4][3] = 0; // axis for rotation (y = 0)
			c[4][4] = 0; // direction for rotation (left)
			c[4][5] = 1.570796; // angle for rotation 
