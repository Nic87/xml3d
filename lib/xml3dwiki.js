...
X3D.main = function() {
    ...
    return {        
        ...
        initRotatates : function(){
            ...
            zRotate.setAxisAngle(rect,0.785);
            rect.z=0;
            rect.x=1;
        ...
        createElementFromGeneric:function(prefix,genericID, x, y, z){
            ...
            this.changeTransformerTranslationX(transformer,parseInt(x.value));
            this.changeTransformerTranslationY(transformer,parseInt(y.value));
            this.changeTransformerTranslationZ(transformer,parseInt(z.value));
            return this;
        },
        ...
        showLights: function() {
            var lights = document.getElementsByTagName("lightshader");
            log.info("found lightshader: "+lights.length);
        },
