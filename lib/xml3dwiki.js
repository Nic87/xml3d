...
X3D.main = function() {
    ...
    return {        
		...
		createElementFromGeneric:function(prefix,genericID, x, y, z){
			...
			log.info('transformer: '+transformer+' transformerid: '+document.getElementById(newTransformerID).getAttribute('id'));
			//window.setTimeout('this.changeTransformerTranslationX('+transformer+','+x+');',1000,'JavaScript');//code,millisec,lang)
