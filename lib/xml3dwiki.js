		...
		*/
        ...
        deleteElement: function() {
            for(var i = 0;i<selectedElems.length;i++) {
                ...
                if (selectedElems[i].getAttribute("visualizer") != null) {
                    var v = selectedElems[i].getAttribute("visualizer");
                    var el;
        ...
        toggleLights: function() {
            ...
            for (var i = 0; i < lights.length; i++) {
                ...
                if (v == null) {
                    ...
                    document.getElementById(v).setAttribute("visualization", l.getAttribute("id"));
                } else {
        ...
        addSelectListener:function(element){
            ...
            this.on('click',function(){
                ...
                if (this.contains(document.getElementById(id))) {
                    this.releaseElementLock(id);
                } else {
                    this.requestElementLock(id);
                }
            }, element);
        },
