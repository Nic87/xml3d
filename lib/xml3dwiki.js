		...
		*/
        ...
        deleteElement: function() {
            for(var i = 0;i<selectedElems.length;i++) {
                ...
                if (selectedElems[i].getAttribute("visualization") != null) {
                    var v = selectedElems[i].getAttribute("visualization");
                    var el;

                    X3D.log.debug("selected item is visualizer, deleting light");
                    selectedElemens.push(document.getElementById(v));
                }
        ...
        toggleLights: function() {
            ...
            for (var i = 0; i < lights.length; i++) {
                ...
                if (v == null) {
                    ...
                    document.getElementById(v).setAttribute("visualization", l.parentNode.getAttribute("id"));
                } else {
		...
		*/
        addSelectListener:function(element){
            ...
            this.on('click',function(){
                ...
                if (this.contains(document.getElementById(id))) {
                    X3D.main.releaseElementLock(id);
                } else {
                    X3D.main.requestElementLock(id);
                }
            }, element);
        },
        
        requestElementLock: function(elementId) {
            X3D.em.publish("data", {
        ...
        releaseElementLock: function(elementId) {
            X3D.em.publish("data", {
        ...
        toggleSelected: function(elementId) {
            elems.push(document.getElementById(elementId));
            this.selectElement();
        }
    }
}();
