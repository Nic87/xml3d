...
X3D.main = function() {
    ...
    return {        
		...
		createElementFromGeneric:function(prefix,genericID, x, y, z){
			...
			this.changeTransformerTranslationX(transformer,x.value);
			this.changeTransformerTranslationY(transformer,y.value);
			this.changeTransformerTranslationZ(transformer,z.value);
            return this;
        },
