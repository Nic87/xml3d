            ...
            for(var i = 0;i<selectedElems.length;i++){
                ...
                switch(parseInt(keyNumber)){
                    case 37:{
						...
						this.changeTransformerTranslationX(transformer,-0.1);
                        break;
                    }
                    case 38:{
